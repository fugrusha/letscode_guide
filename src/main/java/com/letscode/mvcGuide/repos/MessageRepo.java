...
public interface MessageRepo extends CrudRepository<Message, Long> {
    ...
    @Query("select new com.letscode.mvcGuide.domain.dto.MessageDTO(" +
            "m, "+
            "count(ml), " +
    ...
    @Query("select new com.letscode.mvcGuide.domain.dto.MessageDTO(" +
            ...
            "group by m")
    Page<MessageDTO> findMessageByUser(Pageable pageable, @Param("user") User user, @Param("author") User author);
}
